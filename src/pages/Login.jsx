  ...
  return (
    <>
      <section className="flex flex-col justify-center items-center min-h-screen">
        ...
        <form className="grid grid-cols-1 shadow-md m-6 p-6 w-2/3 md:w-1/3 h-64 text-zinc-500">
          <label htmlFor="email" className="my-3 h-10">
            <input type="email" id="email" name="email" placeholder="" className="border-b-2 focus:border-baseblue-100 w-full transition-all ease-in-out outline-none peer/email" value={email} onChange={(e) => setEmail(e.target.value)} />
          ...
          <label htmlFor="password" className="h-10">
            <input
              ...
              name="password"
              placeholder=""
              className="border-b-2 focus:border-baseblue-100 w-full transition-all ease-in-out outline-none peer/password"
              value={password}
          ...
          <button type="submit" onClick={(e) => handleSubmit(e)} className="bg-baseblue-100 px-2 py-1 rounded-full text-white">
            Login
          </button>
        </form>
